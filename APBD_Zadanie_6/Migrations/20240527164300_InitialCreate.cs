    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1999, 5, 27, 18, 43, 0, 77, DateTimeKind.Local).AddTicks(4247), "Jakub", "Nowak" },
                    { 2, new DateTime(2003, 5, 27, 18, 43, 0, 77, DateTimeKind.Local).AddTicks(4291), "Michal", "Kowalski" },
                    { 3, new DateTime(1997, 5, 27, 18, 43, 0, 77, DateTimeKind.Local).AddTicks(4293), "Patient", "Patientowich" },
                    { 4, new DateTime(2002, 5, 27, 18, 43, 0, 77, DateTimeKind.Local).AddTicks(4295), "Sergio", "Kotowich" },
                    { 5, new DateTime(1974, 5, 27, 18, 43, 0, 77, DateTimeKind.Local).AddTicks(4297), "Ala", "Peronska" },
                    { 6, new DateTime(1995, 5, 27, 18, 43, 0, 77, DateTimeKind.Local).AddTicks(4299), "Kot", "Zygmund" },
                    { 7, new DateTime(1970, 5, 27, 18, 43, 0, 77, DateTimeKind.Local).AddTicks(4301), "Natiel", "Patient" },
                    { 8, new DateTime(1957, 5, 27, 18, 43, 0, 77, DateTimeKind.Local).AddTicks(4303), "Jas", "Profase" }
                });
